        ...
        <ul class="nav navbar-nav side-menu" id="sidebarnav">
            ...
            <li>
                ...
                <ul id="dashboard" class="collapse" data-parent="#sidebarnav">
                    ...
                    <li> <a href="{{ URL::route('service') }}">WEBSITE</a> </li>
                </ul>
            </li>
            <!-- menu title -->
            <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">Setings </li>
            <!-- menu item Elements-->
            <li>
                <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                    <div class="pull-left"><i class="ti-palette"></i><span class="right-nav-text">Setings</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div>
                </a>
                <ul id="elements" class="collapse" data-parent="#sidebarnav">
                    <li><a href="{{ URL::route('service.index') }}">Signed</a></li>
                    <li><a href="{{ URL::route('slider.index') }}">Slider Section</a></li>
                    <li><a href="{{ URL::route('about.index') }}">About Us</a></li>
                    <li><a href="{{ URL::route('screen.index') }}">Screen Section</a></li>
                    <li><a href="{{ URL::route('file_upload') }}">File Upload</a></li>
